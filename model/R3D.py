...
class R3DClassifier(nn.Module):
    ...
    def __init__(self, num_class, layer_sizes= (2, 2, 2, 2), block_type=SpatioTemporalResBlock):
...
if __name__ == "__main__":
    import torch
    from tools import test_util

    inputs,_ = test_util.get_input_data(3)
    net = R3DClassifier(4, (2, 2, 2, 2))
