...
from . import head_helper, operators, resnet_helper, stem_helper, vtn_helper  # noqa
...
class MViT(nn.Module):
    ...
    def __init__(self, cfg,num_class):
        ...
        embed_dim = cfg.MVIT.EMBED_DIM # 编码隐藏维度
        # Prepare backbone
...
class VTN(nn.Module):
    ...
    def __init__(self, cfg,num_class):
        ...
        self._construct_network(cfg,num_class)

    def _construct_network(self, cfg,num_class):
        """
        ...
        self.mlp_head = nn.Sequential(
            ...
            nn.Linear(cfg.VTN.MLP_DIM, num_class)
        )
